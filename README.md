...
2. Open a [**new scenario post**](https://github.com/Arkniem/Open-historia-scenarios/issues/new?template=scenario.yml).
...
[**`bundles` release**](https://github.com/Arkniem/Open-historia-scenarios/releases/tag/bundles);
